let phrases = [
  ...
  { text: 'взорвать Статую свободы', image: 'https://code.s3.yandex.net/web-code/procrastinate/10.png' },
  { text: 'I always come back', image: 'https://code.s3.yandex.net/web-code/procrastinate/10.png' },
];
